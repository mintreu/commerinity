...
use App\Filament\Resources\BeneficiaryAccountResource\Pages;
use App\Filament\Resources\BeneficiaryAccountResource\RelationManagers;
use Filament\Forms;
...
class BeneficiaryAccountResource extends Resource
{
    ...
    {
        return [
            'index' => Pages\ListBeneficiaryAccounts::route('/'),
            'create' => Pages\CreateBeneficiaryAccount::route('/create'),
            'view' => Pages\ViewBeneficiaryAccount::route('/{record}'),
            'edit' => Pages\EditBeneficiaryAccount::route('/{record}/edit'),
        ];
    }
}
