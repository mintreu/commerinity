...
return [
    ...
    */
    'default' => [
        'payment'   => 'cash-free',   // Default online payment provider
        'payout'    => 'cash-free',   // Default payout/disbursement provider
