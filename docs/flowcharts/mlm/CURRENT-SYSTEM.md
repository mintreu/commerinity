...
**[← MLM Index](./INDEX.md)** • **[Compare →](./PROPOSED-SYSTEM.md)**
...
CODE (lines 60-63):
    $bonusAmount = $stage
        ...
        : $this->calculatePercent($baseAmount,
            $this->getRateFromConfig('mlm.default_sponsor_bonus_percent', 10));
```
...
| Previous | Up | Next |
|----------|----|----|
| [MLM Index](./INDEX.md) | [Hub](../README.md) | [Proposed System](./PROPOSED-SYSTEM.md) |
