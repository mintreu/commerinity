        ...
        <UCard>
          <div class="space-y-6">
            ...
            >
              ...
              >
                <span class="text-sm text-slate-600 dark:text-slate-400">Reward Points Balance</span>
                <span class="font-semibold text-slate-900 dark:text-white">
                  {{ wallet.points }}
                </span>
              </div>
            ...
            <UAlert
              ...
              description="Your reward points balance is insufficient. Unlock more rewards or choose another payment method."
            />
          </div>
        </UCard>
      </template>
        ...
        <div class="flex gap-3">
          ...
          >
            <UIcon
              ...
              class="w-4 h-4 mr-2"
            />
            {{ paymentMethod === 'wallet' ? 'Pay from Wallet' : paymentMethod === 'coins' ? 'Pay with Rewards' : 'Pay Online' }}
          </UButton>
        </div>
      </template>
    </UModal>
