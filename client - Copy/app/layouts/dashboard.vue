      ...
      <footer class="hidden lg:block px-6 py-4 border-t border-slate-200 dark:border-slate-800 bg-white/50 dark:bg-slate-900/50">
        ...
        <div class="flex items-center justify-between text-sm text-slate-500 dark:text-slate-400">
          <div>
            ...
            <p class="text-xs mt-0.5 opacity-70">Owned and Operated by <strong>{{ config.public.companyLegalName || appName }}</strong></p>
          </div>
...
const appName = config.public.companyName || config.public.appName || 'VRIDDHI VIKASH'
