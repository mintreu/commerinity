...
final class CommissionProcessingCompletedNotification extends Notification implements ShouldQueue
{
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        return $mail
            ->action('View Dashboard', url('/admin/affiliate/commissions'))
            ->line('This is an automated notification from the Affiliate Commission System.');
    }
    ...
    {
        return [
            'type' => 'affiliate_commission_batch',
    ...
    {
        return 'affiliate_commission_batch';
    }
}
