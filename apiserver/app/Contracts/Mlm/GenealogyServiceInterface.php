 ...
 * within the MLM tree structure. Each user has one MlmGenealogy record
...
interface GenealogyServiceInterface
{
     ...
     */
    public function getOrCreate(User $user): MlmGenealogy;

    /**
     * Get genealogy by user ID (cached)
     */
    public function getByUserId(int $userId): ?MlmGenealogy;

    /**
     * Create genealogy for new user
     */
    public function createForUser(User $user, ?User $parent = null, ?User $sponsor = null): MlmGenealogy;
     ...
     */
    public function update(MlmGenealogy $genealogy, array $data): MlmGenealogy;
     ...
     */
    public function placeWithSpillover(User $newUser, User $sponsor): MlmGenealogy;
     ...
     *
     * @return Collection<int, MlmGenealogy>
     */
