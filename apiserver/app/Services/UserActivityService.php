...
final class UserActivityService
{
     ...
     */
    public static function getActivitiesForUser(User $user, int $limit = 50): \Illuminate\Database\Eloquent\Collection
    {
     ...
     */
    public static function getAllActivities(int $limit = 100): \Illuminate\Database\Eloquent\Collection
    {
        return Activity::query()
            ->where('log_name', self::LOG_NAME)
            ->with('causer')
