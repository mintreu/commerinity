...
/**
 * OrderDisplayController - API for user orders
 *
 * Provides:
...
final class OrderDisplayController extends Controller
{
    ...
    private function formatOrder(Order $order, bool $detailed = false): array
    {
        ...
        $data = [
            ...
            'total_reward_points' => $order->total_reward_points ?? 0,
            'total_coins' => $order->total_coins ?? ($order->total_reward_points ?? 0),
    ...
    private function formatOrderItem(OrderItem $item): array
    {
        ...
        return [
            ...
            'total_coins' => $item->total_coins ?? ($item->reward_points ?? 0),
