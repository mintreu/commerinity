...
/**
 * AffiliateGenealogy Model - Tracks Affiliate network stats and matrix placement
 *
 ...
 */
class AffiliateGenealogy extends Model
{
    use HasFactory;
    use SoftDeletes;

    protected static function newFactory(): \Database\Factories\AffiliateGenealogyFactory
    {
        return \Database\Factories\AffiliateGenealogyFactory::new();
    }

    protected $table = 'affiliate_genealogy';
    ...
    {
        static::creating(function (AffiliateGenealogy $genealogy) {
            if (! $genealogy->uuid) {
        ...
        static::saved(function (AffiliateGenealogy $genealogy) {
            static::clearCache($genealogy->user_id);
        });

        static::deleted(function (AffiliateGenealogy $genealogy) {
            static::clearCache($genealogy->user_id);
        });
    }
    ...
    {
        return $this->hasMany(AffiliateGenealogy::class, 'placement_parent_id', 'user_id');
    }
    ...
    {
        return $this->hasMany(AffiliateCommission::class, 'genealogy_id');
    }
