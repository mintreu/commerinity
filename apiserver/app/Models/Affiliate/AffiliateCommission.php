...
/**
 * AffiliateCommission Model - Commission Ledger
 *
 * Tracks all Affiliate commissions with full audit trail:
 * - Sponsor bonuses
...
class AffiliateCommission extends Model
{
    ...
    protected static function newFactory(): \Database\Factories\AffiliateCommissionFactory
    {
        return \Database\Factories\AffiliateCommissionFactory::new();
    }
    ...
    {
        return $this->belongsTo(AffiliateGenealogy::class, 'genealogy_id');
    }
    ...
    {
        return $this->belongsTo(AffiliateCommission::class, 'reversed_commission_id');
    }
    ...
    /**
     * Create referral bonus (non-Affiliate)
     */
