<div>
    ...
    <div class="text-gray-500 mt-4">
        ...
        <p class="font-medium">This transaction has already been completed</p>
    </div>
    @endif
</div>
        ...
        function getCashfreeCheckout() {
            return {
               ...
               // returnUrl: @js($successUrl) // already has {order_id} placeholder
                returnUrl: @js($returnFromProviderUrl)  // this part return final url from provider to our api side
            };
        }
