...
return new class extends Migration
{
     ...
     * Run the migrations.
     *
     * MLM Genealogy table tracks the network tree structure for the 5x4 matrix system.
     * Each user has one genealogy record that tracks their position in the MLM tree,
