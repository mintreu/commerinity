...
return new class extends Migration
{
     ...
     * Run the migrations.
     *
     * MLM Commissions table serves as a complete audit ledger for all commission
    ...
    public function up(): void
    {
        Schema::create('mlm_commissions', function (Blueprint $table) {
            ...
            $table->foreignId('genealogy_id')->nullable()->constrained('mlm_genealogy')->nullOnDelete();
