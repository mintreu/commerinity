...
/**
 * DemoMlmSeeder - Creates a realistic MLM network for testing
 *
 * Structure:
 ...
 */
final class DemoMlmSeeder extends Seeder
{
    ...
    {
        $this->command->info('Starting DemoMlmSeeder...');
        ...
        $this->command->info('DemoMlmSeeder completed!');
    ...
    private function updateGenealogyStats(): void
    {
        ...
        $genealogies = MlmGenealogy::orderBy('depth', 'desc')->get();
