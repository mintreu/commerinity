    ...
    public function run(): void
    {
        ...
        $topics = [
            [
                'name' => 'Guest FAQ',
                'slug' => 'guest-faq',
                'description' => 'General FAQs for public visitors and guests before login.',
            ...
            [
                'name' => 'Regular User FAQ',
                'slug' => 'regular-user-faq',
                'description' => 'FAQs for regular logged-in users and shoppers.',
            ...
            [
                'name' => 'Member FAQ',
                'slug' => 'member-faq',
                'description' => 'FAQs for subscribed members.',
            ...
            [
                'name' => 'Promoter FAQ',
                'slug' => 'promoter-faq',
                'description' => 'FAQs for promoters managing referrals and network growth.',
            ...
            [
                'name' => 'Advisor FAQ',
                'slug' => 'advisor-faq',
                'description' => 'FAQs for advisors handling appointments and client support.',
            ...
            [
                'name' => 'Mentor FAQ',
                'slug' => 'mentor-faq',
                'description' => 'FAQs for mentors running sessions and programs.',
            ...
            [
                'name' => 'Admin FAQ',
                'slug' => 'admin-faq',
                'description' => 'Operational FAQs for admin users and backoffice staff.',
