...
describe('Commission deductions', function () {
    it('applies TDS when threshold exceeded', function () {
        Config::set('affiliate.tds.enabled', true);
        Config::set('affiliate.tds.threshold_monthly', 100000); // 1000 INR
        Config::set('affiliate.tds.rate_percent', 10);
    ...
    it('does not apply TDS below threshold', function () {
        Config::set('affiliate.tds.enabled', true);
        Config::set('affiliate.tds.threshold_monthly', 1000000); // 10000 INR
        Config::set('affiliate.tds.rate_percent', 10);
    ...
    it('applies admin fee when enabled', function () {
        Config::set('affiliate.admin_fee.enabled', true);
        Config::set('affiliate.admin_fee.type', 'percent');
        Config::set('affiliate.admin_fee.value', 5);
...
describe('Commission simulation', function () {
    it('simulates commission calculation without persistence', function () {
        ...
        // Should NOT persist
        expect(AffiliateCommission::where('user_id', $user->id)->count())->toBe(0);
    });
});
