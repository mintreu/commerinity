...
beforeEach(function () {
    $this->configService = new AffiliateConfigService;
});
...
describe('master switches', function () {
    ...
    it('checks originator commissions master switch', function () {
        config(['affiliate.originator_commissions.enabled' => true]);
    ...
    it('checks task commissions master switch', function () {
        config(['affiliate.task_commissions.enabled' => true]);
...
describe('commission type checks', function () {
    ...
    it('gets enabled member types', function () {
        config(['affiliate.member_commissions.enabled' => true]);
        config(['affiliate.member_commissions.sponsor_bonus.enabled' => true]);
        config(['affiliate.member_commissions.level_commission.enabled' => true]);
        config(['affiliate.member_commissions.matching_bonus.enabled' => false]);
...
describe('originator commission config', function () {
    it('gets joining commission config', function () {
        config([
            'affiliate.originator_commissions.enabled' => true,
            'affiliate.originator_commissions.joining_commission.enabled' => true,
            'affiliate.originator_commissions.joining_commission.type' => 'percent',
            'affiliate.originator_commissions.joining_commission.value' => 5,
        ]);
    ...
    it('gets recurring commission config', function () {
        config([
            'affiliate.originator_commissions.enabled' => true,
            'affiliate.originator_commissions.recurring_commission.enabled' => true,
            'affiliate.originator_commissions.recurring_commission.type' => 'percent',
            'affiliate.originator_commissions.recurring_commission.value' => 2,
            'affiliate.originator_commissions.recurring_commission.frequency' => 'on_withdrawal',
        ]);
...
describe('income deduction', function () {
    it('gets income deduction config', function () {
        config([
            'affiliate.income_deduction.enabled' => true,
            'affiliate.income_deduction.percent' => 3,
            'affiliate.income_deduction.description' => 'Platform Fee',
            'affiliate.income_deduction.show_on_invoice' => true,
        ]);
...
describe('agent salary', function () {
    it('gets salary tiers when enabled', function () {
        config([
            'affiliate.agent_salary.enabled' => true,
            'affiliate.agent_salary.tiers' => [
...
describe('tds calculation', function () {
    it('calculates TDS when threshold exceeded', function () {
        config([
            'affiliate.tds.enabled' => true,
            'affiliate.tds.threshold_monthly' => 500000, // ₹5000
            'affiliate.tds.rate_percent' => 10,
        ]);
    ...
    it('returns zero TDS below threshold', function () {
        config([
            'affiliate.tds.enabled' => true,
            'affiliate.tds.threshold_monthly' => 500000,
            'affiliate.tds.rate_percent' => 10,
        ]);
    ...
    it('returns zero TDS when disabled', function () {
        config(['affiliate.tds.enabled' => false]);
...
describe('level features', function () {
    it('gets features at rank when enabled', function () {
        config([
            'affiliate.level_features.enabled' => true,
            'affiliate.level_features.unlocks' => [
    ...
    it('returns empty features when disabled', function () {
        config(['affiliate.level_features.enabled' => false]);
...
describe('dashboard visibility', function () {
    it('resolves dynamic config values', function () {
        config([
            'affiliate.income_deduction.enabled' => true,
            'affiliate.dashboard_visibility.member' => [
