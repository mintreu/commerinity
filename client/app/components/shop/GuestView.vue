...
<template>
  <div class="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-50 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950">
    ...
    <div class="fixed inset-0 pointer-events-none overflow-hidden opacity-20">
      ...
      <div
        class="absolute bottom-20 -right-20 w-80 h-80 bg-gradient-to-r from-fuchsia-400 to-pink-400 rounded-full blur-3xl animate-pulse"
    ...
    <div class="relative">
      ...
      <section
        ...
        class="py-12 md:py-16 bg-white dark:bg-slate-900"
      >
          ...
          <div class="grid grid-cols-2 md:grid-cols-3 gap-4 md:gap-6">
            ...
            >
              ...
              <div class="absolute inset-0">
                ...
                >
                <div
                  v-else-if="category.sample_products?.length"
                ...
                >
                  ...
                  >
                    ...
                    <div
                      v-else
                      class="w-full h-full bg-slate-200 dark:bg-slate-700"
                    />
                  </div>
                </div>
                <div
      ...
      <section
        ...
        class="py-12 md:py-16 bg-gradient-to-br from-amber-50 via-orange-50 to-red-50 dark:from-amber-950/20 dark:via-orange-950/20 dark:to-red-950/20 overflow-hidden"
      >
        <div class="max-w-7xl mx-auto px-4 md:px-6">
      ...
      <section
        ...
        class="py-12 md:py-16 bg-white dark:bg-slate-900 overflow-hidden"
      >
        <div class="max-w-7xl mx-auto px-4 md:px-6">
          <StoreProductCarousel
