...
const handleRegister = async () => {
  ...
  try {
    ...
    const response = await $fetch<{ success: boolean; data: { user: Record<string, unknown>; token: string } }>(`${config.public.apiBase}/api/auth/register`, {
      method: 'POST',
      body: payload
    })
...
<template>
  <div>
    ...
    <div class="flex items-center justify-center gap-2 mb-6">
      <div
        :class="currentStep >= 1 ? 'bg-emerald-500' : 'bg-slate-300 dark:bg-slate-600'"
        class="w-8 h-1 rounded-full transition-colors"
      />
      <div
        :class="currentStep >= 2 ? 'bg-emerald-500' : 'bg-slate-300 dark:bg-slate-600'"
        class="w-8 h-1 rounded-full transition-colors"
      />
      <div
        :class="currentStep >= 3 ? 'bg-emerald-500' : 'bg-slate-300 dark:bg-slate-600'"
        class="w-8 h-1 rounded-full transition-colors"
      />
    </div>
    ...
    <form class="space-y-5" @submit.prevent="handleRegister">
      ...
      <template v-if="currentStep === 1">
        ...
        <button
          ...
          class="w-full flex items-center justify-center gap-2 px-6 py-3 bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-700 hover:to-teal-700 disabled:opacity-50 text-white rounded-xl font-semibold shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-0.5"
          @click="handleSendOtp"
        >
          <UIcon
          ...
          <div class="space-y-2">
            ...
            <div class="relative">
              <input
                ...
                required
                placeholder="123456"
                class="w-full px-4 py-3 pl-12 bg-white dark:bg-slate-700 border-2 border-slate-200 dark:border-slate-600 rounded-xl text-slate-900 dark:text-white placeholder-slate-500 dark:placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all tracking-widest text-center text-lg font-mono"
              >
              <UIcon
                name="i-lucide-hash"
                class="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-slate-500 dark:text-slate-400"
      ...
      <template v-if="currentStep === 2">
        <div class="space-y-2">
          ...
          <div class="relative">
            <input
              ...
              class="w-full px-4 py-3 pl-12 bg-white dark:bg-slate-700 border-2 border-slate-200 dark:border-slate-600 rounded-xl text-slate-900 dark:text-white placeholder-slate-500 dark:placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all"
            >
            <UIcon
              name="i-lucide-user"
              class="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-slate-500 dark:text-slate-400"
        ...
        <div class="space-y-2">
          ...
          <div class="relative">
            <input
              ...
              class="w-full px-4 py-3 pl-12 bg-white dark:bg-slate-700 border-2 border-slate-200 dark:border-slate-600 rounded-xl text-slate-900 dark:text-white placeholder-slate-500 dark:placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all uppercase"
            >
            <UIcon
        ...
        <div class="flex gap-3">
          ...
          <button
            type="button"
            :disabled="!form.name"
            class="flex-1 flex items-center justify-center gap-2 px-6 py-3 bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-700 hover:to-teal-700 disabled:opacity-50 text-white rounded-xl font-semibold shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-0.5"
            @click="currentStep = 3"
          >
            <span>Continue</span>
            <UIcon name="i-lucide-arrow-right" class="w-5 h-5" />
      ...
      <template v-if="currentStep === 3">
        <div class="space-y-2">
          ...
          <div class="relative">
            <input
              ...
              class="w-full px-4 py-3 pl-12 pr-12 bg-white dark:bg-slate-700 border-2 border-slate-200 dark:border-slate-600 rounded-xl text-slate-900 dark:text-white placeholder-slate-500 dark:placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all"
            >
            <UIcon
              name="i-lucide-key"
              class="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-slate-500 dark:text-slate-400"
        ...
        <div class="space-y-2">
          ...
          <div class="relative">
            ...
            <UIcon
              ...
              class="absolute right-4 top-1/2 -translate-y-1/2 w-4 h-4 text-emerald-500"
            />
          </div>
        </div>
        ...
        <label class="flex items-start gap-3 cursor-pointer">
          <input
            ...
            type="checkbox"
            required
            class="w-5 h-5 mt-0.5 text-emerald-600 rounded border-slate-300 dark:border-slate-600 focus:ring-emerald-500"
          >
        ...
        <div class="flex gap-3">
          ...
          <button
            ...
            class="flex-1 flex items-center justify-center gap-2 px-6 py-3 bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-700 hover:to-teal-700 disabled:opacity-50 text-white rounded-xl font-bold shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-0.5"
          >
            <UIcon
