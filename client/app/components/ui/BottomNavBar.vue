<template>
  <div class="flex items-center justify-around h-16 px-2 safe-area-bottom">
    ...
    <template v-if="!isLoggedIn">
      ...
      >
        <div class="nav-icon-wrapper">
          ...
          <div v-if="isActiveRoute('/shop')" class="nav-indicator" />
        </div>
      ...
      >
        <div class="nav-icon-wrapper">
          <Icon name="lucide:grid-2x2" class="w-6 h-6" />
          <div v-if="isActiveRoute('/categories')" class="nav-indicator" />
        </div>
      ...
      >
        <div class="nav-icon-wrapper">
          <div class="nav-icon-primary">
            <Icon name="lucide:log-in" class="w-5 h-5 text-white" />
          </div>
        </div>
    ...
    <template v-else>
      ...
      >
        <div class="nav-icon-wrapper">
          <Icon name="lucide:grid-2x2" class="w-6 h-6" />
          <div v-if="isActiveRoute('/categories') || isActiveRoute('/category')" class="nav-indicator" />
        </div>
        <span class="nav-label">Category</span>
      </NuxtLink>
      ...
      >
        <div class="nav-icon-wrapper">
          <Icon name="lucide:user-circle" class="w-6 h-6" />
          <div v-if="route.path === '/dashboard' || isActiveRoute('/dashboard/account') || isActiveRoute('/dashboard/profile')" class="nav-indicator" />
        </div>
      ...
      >
        <div class="nav-icon-wrapper">
          ...
          <div v-if="isMoreMenuOpen" class="nav-indicator" />
        </div>
  ...
  <!-- More Menu Drawer -->
  <USlideover v-model:open="isMoreMenuOpen" side="right">
    <template #header>
