          ...
          <div class="grid grid-cols-1 gap-12 lg:grid-cols-12 lg:gap-8">
            ...
            <div class="lg:col-span-8 grid grid-cols-2 gap-8 sm:grid-cols-3 lg:grid-cols-4">
              ...
              <nav class="footer-section">
                <h4 class="text-sm font-bold text-gray-900 dark:text-white mb-4 uppercase tracking-wide">
                  Shop
                </h4>
                  ...
                  >
                    ...
                    >
                      <Icon
                        ...
                        class="w-4 h-4 opacity-0 group-hover:opacity-100 -ml-4 group-hover:ml-0 transition-all"
                      />
                ...
                <ul class="space-y-3 text-sm text-gray-600 dark:text-gray-400">
                  <li class="flex items-start gap-2">
                    ...
                    <a
                      ...
                      class="hover:text-blue-600 dark:hover:text-blue-400 transition-colors break-all"
                    >
                      {{ siteConfig.email }}
                    </a>
                  </li>
