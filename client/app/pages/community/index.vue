 ...
 * Community Page
 *
 * Premium community visualization with:
...
const viewMemberCommunity = async (referralCode: string) => {
      ...
      <div class="glass-card p-5">
        <div class="flex items-center justify-between">
          <div>
            ...
            <p class="text-2xl font-bold text-violet-600 dark:text-violet-400 mt-1">
              {{ maxDepth }}
            </p>
          </div>
            ...
            >
              ...
              <td class="px-6 py-4 whitespace-nowrap text-sm">
                <UButton
                  ...
                  color="primary"
                  size="sm"
                  @click.stop="viewMemberCommunity(member.referral_code)"
                >
                  View Community
                </UButton>
              </td>
    ...
    >
      ...
      >
        ...
        <div class="space-y-3">
          ...
          <div class="grid grid-cols-2 gap-3">
            <div class="bg-gray-50 dark:bg-gray-800 rounded-xl p-4 text-center">
              <UIcon
                name="i-lucide-layers"
                class="w-6 h-6 text-violet-600 mx-auto mb-2"
              />
        ...
        <UButton
          ...
          size="lg"
          class="mt-4"
          @click="viewMemberCommunity(selectedMember.referral_code)"
        >
          <UIcon
            name="i-lucide-git-branch"
            class="w-5 h-5 mr-2"
