 ...
 * Mentor Page
 *
 * Shows the direct mentor/sponsor - only 1 record
 * Clean, focused design for displaying mentor info
 */
...
const fetchParent = async () => {
  ...
  try {
    ...
    if (response?.success && response?.data) {
      // Upline returns array, we only need the first one (direct mentor)
  ...
  <div class="max-w-2xl mx-auto space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
      <div>
        ...
        <p class="text-gray-500 dark:text-gray-400">
          The person who introduced you to our platform
        </p>
      </div>
      <UButton
        to="/community"
        ...
        <div class="flex items-start gap-3 p-4 bg-blue-50 dark:bg-blue-900/20 rounded-xl">
          ...
          <div>
            ...
            <p class="text-xs text-blue-600 dark:text-blue-400 mt-1">
              This is the person who referred you to the community. Contact them for guidance and support in your journey.
            </p>
          </div>
        </div>
      </div>
    ...
    >
      ...
      <p class="text-gray-500 dark:text-gray-400 max-w-sm mx-auto">
        You don't have a mentor. This means you joined the community as a top-level member.
      </p>
    </div>
