        ...
        <div class="flex flex-col lg:flex-row items-center lg:items-start gap-10">
          ...
          <div class="shrink-0 flex gap-3">
            <UButton
              ...
              variant="soft"
              size="xl"
              class="rounded-2xl font-black px-6"
            >
              <template #leading>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-5 gap-8">
      ...
      <div class="lg:col-span-3 space-y-8">
        ...
        <div class="grid sm:grid-cols-2 gap-6">
          <NuxtLink
            to="/profile/kyc"
            class="glass-card p-6 border-none ring-1 ring-slate-200 dark:ring-slate-800 hover:bg-white dark:hover:bg-slate-800 transition-all group"
          >
      ...
      <div class="lg:col-span-2 space-y-8">
        ...
        <div class="glass-card relative overflow-hidden p-8 border-none bg-slate-900 text-white shadow-2xl">
          ...
          <h3 class="text-xs font-black uppercase tracking-[0.3em] mb-6 relative z-10 text-white/50 text-center">
            Current Rank
          </h3>
          ...
          <div class="flex flex-col items-center gap-4 relative z-10">
            ...
            >
              <div class="w-full h-full rounded-[38px] bg-slate-900 flex items-center justify-center p-2">
                <UIcon
                  :name="getRankIcon(currentLevel.name)"
                  :class="`w-16 h-16 text-${getRankColor(currentLevel.badge_color)}-400`"
                />
              </div>
            </div>
            <div
              v-else
              class="w-32 h-32 rounded-[40px] bg-gradient-to-br from-slate-600 to-slate-700 p-1 mx-auto shadow-2xl"
            >
              <div class="w-full h-full rounded-[38px] bg-slate-900 flex items-center justify-center p-2">
                <UIcon
                  name="i-lucide-medal"
            ...
            <div class="text-center">
              ...
              <p class="text-2xl font-black">
                {{ currentLevel?.full_name || 'No Rank Yet' }}
              </p>
              <p
                v-if="currentStage"
                class="text-xs font-bold text-white/60 uppercase tracking-widest mt-1"
              >
            ...
            <div
              v-if="currentLevel"
              class="flex items-center gap-2 px-4 py-2 bg-white/5 rounded-full"
            >
              <UIcon
                name="i-lucide-hash"
        ...
        >
          ...
          <div class="grid grid-cols-2 gap-4">
            <div
              ...
              :key="stat.label"
              class="flex items-center gap-3 p-3 bg-slate-50 dark:bg-slate-800/50 rounded-xl"
            >
              <UIcon
                :name="stat.icon"
