...
use Mintreu\LaravelRecruitment\Filament\Resources\RecruitmentResource\RelationManagers;
...
class RecruitmentResource extends Resource
{
    ...
    {
        return [
            'index' => \Mintreu\LaravelRecruitment\Filament\Resources\RecruitmentResource\Pages\ListRecruitments::route('/'),
            'create' => \Mintreu\LaravelRecruitment\Filament\Resources\RecruitmentResource\Pages\CreateRecruitment::route('/create'),
            'view' => \Mintreu\LaravelRecruitment\Filament\Resources\RecruitmentResource\Pages\ViewRecruitment::route('/{record:url}'),
            'edit' => \Mintreu\LaravelRecruitment\Filament\Resources\RecruitmentResource\Pages\EditRecruitment::route('/{record:url}/edit'),
        ];
    }
}
