# MLM Matrix 5×4 System - Focused Architecture Plan
...
| Table | Purpose |
|-------|---------|
| `mlm_genealogy` | Tree structure, sponsor paths, team counts |
| `mlm_commissions` | Commission ledger with full audit trail |
...
### 2.4 `mlm_genealogy` - NEW: Network Tree Structure
...
### 2.5 `mlm_commissions` - NEW: Commission Ledger
...
```
1. YYYY_MM_DD_000001_add_mlm_columns_to_stages_table.php
2. YYYY_MM_DD_000002_add_mlm_columns_to_levels_table.php
3. YYYY_MM_DD_000003_add_mlm_columns_to_user_subscriptions_table.php
4. YYYY_MM_DD_000004_create_mlm_genealogy_table.php
5. YYYY_MM_DD_000005_create_mlm_commissions_table.php
```
...
| `mlm_genealogy` | **NEW** | Tree structure, counters, paths |
| `mlm_commissions` | **NEW** | Commission ledger with audit trail |
...
- [ ] Approve new `mlm_genealogy` table
- [ ] Approve new `mlm_commissions` table
