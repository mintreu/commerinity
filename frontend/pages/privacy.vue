  ...
  <div class="min-h-screen w-screen  bg-gradient-to-br from-gray-50 via-indigo-50 to-purple-50 dark:from-gray-950 dark:via-indigo-950 dark:to-purple-950 overflow-x-hidden">
    ...
    <div class="relative z-10 px-4 lg:px-20 py-12">
      ...
      <div class="back-to-top fixed bottom-8 right-8 z-20">
        <button
            @click="scrollToTop"
            class="w-14 h-14 bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white rounded-full shadow-2xl hover:shadow-indigo-500/25 transition-all duration-300 transform hover:scale-110 flex items-center justify-center"
        >
