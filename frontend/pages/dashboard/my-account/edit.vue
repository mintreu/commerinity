      ...
      <div class="grid grid-cols-1 md:grid-cols-[250px_1fr] divide-y md:divide-y-0 md:divide-x divide-gray-200 dark:divide-gray-700">
        ...
        <div class="p-6 space-y-6">
          <div class="flex flex-col gap-4">
            ...
            <div class="gap-2 my-2">
              <label>Bio</label>
              <textarea ref="bioRef" v-model="form.bio" class="form-input resize-none overflow-hidden" rows="1" maxlength="500" placeholder="Write something about yourself" @input="resizeBio"></textarea>
